...
html_content = '''const FORMATIONS_HTML_7V7 = `
  <style>
...
styles = [
    {
        'id': 'tiki_taka', 'formation': '2-3-1', 'title': 'Tiki-Taka', 'subtitle': 'Juego de Posición',
    ...
    {
        'id': 'catenaccio', 'formation': '3-2-1', 'title': 'Catenaccio Moderno', 'subtitle': 'Muro y Contragolpe',
    ...
    {
        'id': 'gegenpressing', 'formation': '3-2-1', 'title': 'Gegenpressing', 'subtitle': 'Presión Asfixiante',
    ...
    {
        'id': 'asociativo', 'formation': '2-3-1', 'title': 'Asociativo', 'subtitle': 'Sociedad Central',
    ...
    {
        'id': 'directo', 'formation': '2-2-2', 'title': 'Fútbol Directo', 'subtitle': 'La Vía Directa',
...
file_path = 'frontend/js/ui/draft.js'
with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Instead of substituting FORMATIONS_HTML, we append FORMATIONS_HTML_7V7 right after it.
if 'const FORMATIONS_HTML_7V7' in content:
    content = re.sub(r'const FORMATIONS_HTML_7V7 = `.*?`;', html_content.strip(), content, flags=re.DOTALL)
else:
    content = re.sub(r'(const FORMATIONS_HTML = `.*?`;)', r'\1\n\n' + html_content.strip(), content, flags=re.DOTALL)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)

print("Updated draft.js successfully with 7v7 formations!")
